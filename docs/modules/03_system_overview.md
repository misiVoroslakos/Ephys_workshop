...
1. **Recording probe / electrode / device**
2. **Microdrive / shuttle / drive / manipulator**
3. **Headstage / preamp / amplifier**
4. **Recording cable**
5. **Recording device / DAQ**
6. **I/O expander + analog/digital inputs** (sync + behavior integration)
7. **Ground, reference**
